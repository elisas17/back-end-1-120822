<div class="contatobox">
    <div class="contato-div">
        <h1 class="h1s">ATENDIMENTO AO CLIENTE</h1>
        <p>(51) 1111-1111</p>
        <h1 class="h1s">EMAIL</h1>
        <p>ritadirce@marmitas.com.br</p>
    </div>
    <div class="form-div">
        <h1 class="h1s">CONTATO</h1>
        <div class="form">
           <form action="" id="formulario" method="POST" name="formulario">
            ...
            <input type="number" id="telefone" placeholder="Telefone"/><br>
